...
> **Windows:** `curl.exe` + token — [CURLS-P](CURLS-P.md) · [FAQ](FAQ-TRAVOU.md).
...
> **Shell:** Git Bash abaixo. **PowerShell:** `curl.exe` + `Invoke-RestMethod` para o token — [CURLS-P](CURLS-P.md) · [FAQ](FAQ-TRAVOU.md).
