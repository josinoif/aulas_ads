...
- Arquivos enviados serão armazenados na pasta `uploads` (crie a pasta na raiz do projeto se não existir, ou o Multer a criará automaticamente em tempo de execução em muitas configurações).
